...
class HomeController extends Controller
{
    ...
    public function product_details($id) {
        $product = Product::findOrFail($id); // Use findOrFail to get the product or throw a 404 error if not found
    ...
    public function add_cart(Request $request ,$id){
        if(Auth::id()) {
            ...
            if ($product_exist_id) {
                ...
                //Alert::warning(success('Product Added Successfully','We Have Added Product To The Cart'));
